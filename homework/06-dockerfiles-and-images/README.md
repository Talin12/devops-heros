...
## Screenshot: the app on port 8080

![Multi-stage app on port 8080](screenshots/01-app-8080.png)

Taken at <http://localhost:8080>. This is the page served by the `hw-multistage`
container, the one showing `0.0.0.0:8080->3000/tcp` in the `docker ps` output above.
